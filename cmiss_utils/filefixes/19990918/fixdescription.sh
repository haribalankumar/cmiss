...
#
# Usage:
#   ${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixdescription.sh
#
# Created:
#   Shane Blackett 1 May 2000
#

FILESTOCHANGE=description.html

#
# The awk script to use to change the file
#
AWKSCRIPT=${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixdescription.awk
#
...
#
LOGFILE=${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixdescription.log 
#
# The name of this script as written into the comfiles when changes
# are made.
#
SCRIPTNAME=fixdescription.sh
...
#
find . -type f -name "$FILESTOCHANGE" > $LISTOFFILES
