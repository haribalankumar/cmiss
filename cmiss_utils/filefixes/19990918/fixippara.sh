#! /bin/sh
#
# This is a shell script to add another parameter to ippara files
#
# Usage:
#   ${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixippara.sh
#
# Created:
#   Martin Buist, Tuesday November 16 1999
#   Added: NTIMEPOINTSM,NTIMEVARSM
#
# Updates:
#
...
#
FILESTOCHANGE=*.ippara

#
# The awk script to use to change the file
#
AWKSCRIPT=${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixippara.awk

#
# Location of the list of files changed
#
LISTOFFILES=/tmp/fixippara_${LOGNAME}.files
