#! /bin/sh
#
# The is a shell script to alter .ipcell files
#
# Usage:
#   ${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixipcell.sh
#
# Created:
#   Karl Tomlinson, 14/3/00
#
# Updates:
#  
#
...
#
FILESTOCHANGE=*.i?cell

#
# The awk script to use to change the file
#
AWKSCRIPT=${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixipcell.awk

#
# Location of the list of files changed
#
LISTOFFILES=/tmp/fixipcell_${USER}.files
