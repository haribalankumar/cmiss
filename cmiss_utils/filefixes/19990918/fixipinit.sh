#! /bin/sh
#
# The is a shell script to add another question to  i?init files
#
# Usage:
#   ${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixipinit.sh
#
# Created:
#   Martin Buist , 22/11/1999
#
# Updates:
#  
#
...
#
FILESTOCHANGE=*.i?init

#
# The awk script to use to change the file
#
AWKSCRIPT=${CMISS_ROOT}/cmiss_utils/filefixes/19990918/fixipinit.awk

#
# Location of the list of files changed
#
LISTOFFILES=/tmp/fixipinit_${LOGNAME}.files
