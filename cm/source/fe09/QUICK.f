      REAL*8 FUNCTION QUICK(nfv,NFVC,nh,NPNODE,nr,nvc,NVCNODE,NYNP,
     '  TC,TD,VC,XNFV,YP)

C#### Function: QUICK
C###  Type: REAL*8
C###  Description: Computes the Quadratic upstream interpolation for
C###    convective kinematics. It assumes that flow is from velocity
C###    TC to TD. (Upwinding on velocity TC).
...
!     Local Variables
      ...
      REAL*8 DDOT,CURVN,DIST,TEMP,CF
