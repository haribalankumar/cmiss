      SUBROUTINE EXPON(STR1,STR2,ERROR,*)

C#### Subroutine: EXPON
C###  Description:
C###    EXPON replaces STR1 with STR1^STR2.
...
CC$        call mp_unsetlock()
      ...
      IF(STR2(1:1).EQ.'[') THEN
        OP_STRING(1)='Incompatible strings in exponentiate'
