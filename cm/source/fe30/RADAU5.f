...
C#### Dummy subroutine required for RADCOR.f


      IMPLICIT NONE
      DOUBLE PRECISION X,Y,DFY
      REAL*8 RPAR
      INTEGER N,LDFY,IPAR
      
      CALL ENTERS('JAC',*9999)
      
 9999 CALL EXITS('JAC')
      RETURN
      END
      
C     END OF SUBROUTINE JAC
C ----------------------------------------------------------
...
C#### Dummy subroutine required for RADCOR.f
      ...
      CALL ENTERS('MAS',*9999)
      
 9999 CALL EXITS('MAS')
      RETURN
      END
      
C     END OF SUBROUTINE MAS
C ----------------------------------------------------------
...
C#### Dummy subroutine required for RADCOR.f
      ...
      IMPLICIT NONE
      REAL*8 XOLD,RPAR
      INTEGER NR,IPAR,IRTRN,LRC,N
      DOUBLE PRECISION X,Y,CONT
      
      CALL ENTERS('SOLOUT',*9999)
      
 9999 CALL EXITS('SOLOUT')
      RETURN
      END

C     END OF SUBROUTINE SOLOUT
C ----------------------------------------------------------
