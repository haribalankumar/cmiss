      SUBROUTINE IPELEMORIG(IBT,nbasis,NBJ,NEELEM,NELIST,NENP,NE_OFFSET,
...
C                   OC_COUNT'th occurance of np in the element list
                    ...
                    IF(FIRST_VERSION) THEN
                      IF(.NOT.TREE)THEN
C XY/MPN 4JUNE2015:  copied from below to correct the default for the first node version
...
C  old   XY/MPN 4JUNE2015:                          IDEFLT(1)=1
                      ELSE
