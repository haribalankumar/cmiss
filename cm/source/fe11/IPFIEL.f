      SUBROUTINE IPFIEL(NEELEM,NENP,NJJ_END,
...
C unused in move to IPFIEL_NJLOC: FREELIST(NJ_LOC_MX)      
      CHARACTER CHAR2*2,CHAR1*1,CHAR11*2,CHAR3*1,CHAR4*6,
     '  CHAR12*12
...
c            DO njj=NJJ_START,NJ_LOC(NJL_FIEL,0,nr)
     ...
     &              ']: '',I2)'
                  ELSE
                  FORMAT='($,'' The number of versions for'
     '              //' field variable '//CHAR11//' is ['//CHAR3//
     &              ']: '',I2)'
                  ENDIF
