      SUBROUTINE CELLML_TERMINATE(ERROR_CODE)

C#### Subroutine: CELLML_TERMINATE
C###  Description:
...
C###  non-zero value if an error occurs during termination.
      ...
      CALL CellMLProcessorTerminate(ERROR_CODE)
