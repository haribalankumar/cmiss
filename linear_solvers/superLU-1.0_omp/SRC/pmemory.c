...
#elif ( MACH==OPENMP )
	omp_set_lock( &pxgstrf_shared->lu_locks[ULOCK] );
...
#elif ( MACH==OPENMP )
	omp_unset_lock( &pxgstrf_shared->lu_locks[ULOCK] );
#elif ( MACH==CRAY_PVP )
...
#elif ( MACH==OPENMP )
	omp_set_lock( &pxgstrf_shared->lu_locks[LLOCK] );
#elif ( MACH==SGI || MACH==ORIGIN )
...
#elif ( MACH==OPENMP )
	omp_unset_lock( &pxgstrf_shared->lu_locks[LLOCK] );
#elif ( MACH==CRAY_PVP )
...
#elif ( MACH==OPENMP )
    omp_set_lock( &pxgstrf_shared->lu_locks[LULOCK] );
#elif ( MACH==SGI || MACH==ORIGIN )
