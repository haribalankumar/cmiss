...
C   - changed loops to take advantage of OMP calls
...
C
     ...
     &          JC, J, JJC1, JJCF, JJCF1, JJCF2, JJF1, K, KK
...
C$OMP PARALLEL DO
CC$OMP& DEFAULT(NONE)
C$OMP& PRIVATE(I,IC,J,JC,CO,CS,CSW,CW,CNW,CN,
C$OMP&         COSW,CSSW,CSWSW,CWSW,COA,CEA,
C$OMP&         CSEA,CSA,CSWA,CWA,CONW,CENW,CSENW,
C$OMP&         CFNW,CNE,CE,CSE)
C$OMP& SHARED(CI,IIC1,JJC1,SO,SOC)
         DO KK=1,(IIC1-1)*(JJC1-1)
