...
C ==========================================================================
C 
C   BMG3_SymStd_PRECON_boxmg
C
C   --------------------
C   DESCRIPTION:
C   --------------------
C
C   BMG3_SymStd_PRECON_boxmg is used to wrap the call to 
C   the BoxMG solver, BMG3_SymStd_SOLVE_boxmg, for 
C   preconditioning in BMG3_SymStd_SOLVE_pcg.
C
C   ---------------------
C   HISTORY:  
C   ---------------------
...
C 
     ...
     &         BMG_pWORK(NBMG_pWORK), BMG_iWORK_PL(NBMG_iWORK_PLm),
     &         BMG_IJK_MAP(*)
