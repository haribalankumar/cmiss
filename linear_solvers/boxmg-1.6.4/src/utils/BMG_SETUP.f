...
C   --------------------
C
C   BMG_SETUP calls either BMG2_SymStd_SOLVE_boxmg or it calls 
C   BMG3_SymStd_SOLVE_boxmg depending on ND to setup the problem.
C
...
C ========================================================================
      ...
      ! Eventually have option to setup either BOXMG or BOXMG-PCG
     ...
     &            BMG_rWORK(BMG_pWORK(ip_CU)), NCBW, NCU,
     &            BMG_iWORK(BMG_pWORK(ip_iG)), NOG, NOGc,
     &            BMG_iWORK_PL(1), NBMG_iWORK_PL, 
     &            BMG_rWORK_PL(1), NBMG_rWORK_PL,
     &            BMG_IJK_MAP
     &            )
