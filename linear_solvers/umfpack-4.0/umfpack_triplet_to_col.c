...
)
{
	...
	if (do_values)
	{
	    status = UMF_triplet_map_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp, Rj, W, RowCount
		, Tx, Ax, Rx
#ifdef COMPLEX
		, Tz, Az, Rz
#endif
	...
	{
	    status = UMF_triplet_map_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp, Rj, W, RowCount
		, Map, Map2) ;
	}
    }
    else
	...
	if (do_values)
	{
	    status = UMF_triplet_nomap_x (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp, Rj, W, RowCount
		, Tx, Ax, Rx
#ifdef COMPLEX
		, Tz, Az, Rz
#endif
	...
	{
	    status = UMF_triplet_nomap_nox (n_row, n_col, nz, Ti, Tj, Ap, Ai, Rp, Rj, W, RowCount
		) ;
	}
    }
